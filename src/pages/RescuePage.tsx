  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <HeroSection
        ...
        title="Report Animal Emergency"
        subtitle="Found an animal in need? Report it here and our rescue team will respond as quickly as possible."
      />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* ✅ Rescue Form */}
        {/* Keep the rest of the rescue form here */}
      </div>
    </div>
  );
};
